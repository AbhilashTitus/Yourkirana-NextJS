                ...
                <div className="container">
                    <div className="feature-card" style={{ maxWidth: '900px', margin: 'auto' }}>
                        ...
                        <p style={{ marginBottom: '20px', lineHeight: '1.8' }}>
                            YourKirana is a leading e-commerce platform operated by <strong>Nexora Solutions Private Limited</strong>,
                        ...
                        <ul style={{ lineHeight: '2', marginLeft: '20px' }}>
                            <li><strong>Legal Name:</strong> Nexora Solutions Private Limited</li>
                            <li><strong>Registered Office:</strong> Bangalore, Karnataka, India</li>
