...
export default function AdminPage() {
    ...
    const filteredProducts = products.filter(p => {
        ...
        const matchesSearch = productSearchQuery ?
            ...
            p.id.toLowerCase().includes(productSearchQuery.toLowerCase()) : true;
    ...
    const filteredCategories = categories.filter(c => {
        const matchesSearch = categorySearchQuery ?
            ...
            c.id.toLowerCase().includes(categorySearchQuery.toLowerCase()) : true;
                        ...
                        {(isAddingNewProduct || editingProduct) && (
                            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 mb-8 animate-fadeIn">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <button onClick={cancelProductEdit} className="text-gray-400 hover:text-gray-600 transition-colors">
                                ...
                                <form onSubmit={handleProductSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            {(imagePreview || productFormData.image) && (
                                                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                                                    ...
                                                    <div className="text-sm text-gray-600">
                                                        ...
                                                        <p className="text-xs text-gray-400 mt-1">{productFormData.image}</p>
                                                    </div>
                                                </div>
                                            )}
                                    ...
                                    <div className="md:col-span-2 flex gap-4">
                                        ...
                                        <button type="button" onClick={cancelProductEdit} className="btn flex-1" style={{ background: '#f3f4f6', color: '#374151' }}>
                                            Cancel
                                        </button>
                                    </div>
                                </form>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-gray-500 text-sm font-medium">Filtered Results</p>
                                        <p className="text-3xl font-bold text-gray-900 mt-1">{filteredCategories.length}</p>
                                    </div>
                                    <div className="bg-purple-50 p-4 rounded-xl">
                                        <svg className="w-8 h-8 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                        ...
                        {(isAddingNewCategory || editingCategory) && (
                            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100 mb-8 animate-fadeIn">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    <button onClick={cancelCategoryEdit} className="text-gray-400 hover:text-gray-600 transition-colors">
                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                    </button>
                                ...
                                <form onSubmit={handleCategorySubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setCategoryFormData({ ...categoryFormData, id: e.target.value.toLowerCase().replace(/\s+/g, '-') })}
                                            required
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setCategoryFormData({ ...categoryFormData, href: e.target.value })}
                                            required
                                        ...
                                        <div className="space-y-4">
                                            {(imagePreview || categoryFormData.image) && (
                                                <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border-2 border-dashed border-gray-200">
                                                    ...
                                                    <div className="text-sm text-gray-600">
                                                        <p className="font-medium">Current Image</p>
                                                        <p className="text-xs text-gray-400 mt-1">{categoryFormData.image}</p>
                                                    </div>
                                                </div>
                                            )}
                                    ...
                                    <div className="md:col-span-2 flex gap-4">
                                        ...
                                        <button type="button" onClick={cancelCategoryEdit} className="btn flex-1" style={{ background: '#f3f4f6', color: '#374151' }}>
                                            Cancel
                                        </button>
                                    </div>
                                </form>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {filteredCategories.map((category) => (
                                <div key={category.id} className="card group hover:shadow-2xl transition-all duration-300">
                                    <div className="pic relative overflow-hidden">
                                    ...
                                    <div className="body">
                                        ...
                                        <p className="text-sm text-mint font-medium mt-2">{category.href}</p>
                                    </div>
                                    <div className="flex gap-2 p-4">
                                        <button
